...
parfor t=1:p.trials
    ...
    for k=1:length(p.SNRdB_list)
        ...
        dataBits_out_K_best_Unc=zeros(128,1);
        ...
        dataBits_out_K_best_Unc2=dataBits_out_K_best_Unc(1:p.encLen)';
        [databits_out_K_best_padded,~,n_guess,abandoned] = bin_GRAND(H1,inf,dataBits_out_K_best_Unc2); %grand goes here
        databits_out_K_best = (databits_out_K_best_padded(1:p.dataLen))';
        ...
        dataBits_out_ML_hard_Unc2=dataBits_out_ML_hard_Unc(1:p.encLen)';
        [databits_out_ML_hard_padded,~,~,~] = bin_GRAND(H1,inf,dataBits_out_ML_hard_Unc2); %grand goes here
        databits_out_ML_hard = databits_out_ML_hard_padded(1:p.dataLen)';
        ...
        dataBits_out_SP_hard_Unc=zeros(128,1);
        for tt=1:length(y_bch)
        ...
        dataBits_out_SP_hard_Unc2=dataBits_out_SP_hard_Unc(1:p.encLen)';
        [databits_out_SP_hard_padded,~,~,~] = bin_GRAND(H1,inf,dataBits_out_SP_hard_Unc2); %grand goes here
        databits_out_SP_hard = databits_out_SP_hard_padded(1:p.dataLen)';
        ...
        dataBits_out_SSD_hard_Unc=zeros(128,1);
        for tt=1:length(y_bch)
        ...
        dataBits_out_SSD_hard_Unc2=dataBits_out_SSD_hard_Unc(1:p.encLen)';
        [databits_out_SSD_hard_padded,~,~,~] = bin_GRAND(H1,inf,dataBits_out_SSD_hard_Unc2); %grand goes here
        databits_out_SSD_hard = databits_out_SSD_hard_padded(1:p.dataLen)';
